...
const sendSignShareFeatures = [
  ...
  },
  {
    ...
    description:
      "Aggregate and share the fees charged across all your service agreements to without disclosing customer information.",
    icon: ScaleIcon,
  },
];
const web3Features = [
...
export default function HompageFeatures() {
  return (
